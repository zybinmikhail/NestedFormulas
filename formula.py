...
def LearnFormula(X, y, optimizer_for_formula, device, n_init=10, max_iter=10000, 
            ...
            minimal_acceptable_improvement=1e-5) -> RecursiveFormula:
    """
    Parameters:
    ...
    #     torch.random.manual_seed(seed)
        formula = RecursiveFormula(depth, X.shape[1]).to(device)
        
        optimizer = optimizer_for_formula(formula.parameters(), lr)
