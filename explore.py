...
def print_time(cnt, cnt_iteration):
    ...
    print(f"{auxiliary_functions.remove_zero_minutes(min_from_start)}{sec_from_start :.0f} seconds passed from the start, ", end="")
...
def explore(n_variables=3, m_samples=1000, min_power=1, max_power=1, number_of_tested_formulas=10, recovery_threshold=1e-4,
           divide_powers_by=1):
